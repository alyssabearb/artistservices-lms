...
/** Section card title (largest red) unchanged. Body rich text: # = former ## scale/red, ## = former ### size + red, ### black unchanged. */
...
function lmsAtxHeadingClass(embedInCourseDetail, depth) {
  ...
  if (embedInCourseDetail) {
    if (d === 1) return "font-bold text-[#E61C39] text-xl md:text-2xl mt-3 mb-2 leading-tight";
    if (d === 2) return "font-bold text-[#E61C39] text-lg md:text-xl mt-3 mb-1.5 leading-snug";
    if (d === 3) return "font-bold text-black text-lg md:text-xl mt-3 mb-1.5 leading-snug";
...
/** Gallery index lives here so prev/next does not re-run the whole section (keeps layout + neighbors stable). */
...
export default function Block(props) {
  ...
  function renderRichText(content) {
    ...
    var proseClass = embedInCourseDetail
      ? "prose prose-sm max-w-none text-black [&_a]:!underline [&_strong]:!font-bold [&_ul]:!pl-7 [&_ul_ul]:!pl-4 [&_ol]:!pl-7 [&_ol_ol]:!pl-4 [&_ul]:!list-outside [&_ol]:!list-outside " + headingProse
      : "prose prose-base max-w-none text-black [&_a]:!underline [&_strong]:!font-bold [&_ul]:!pl-8 [&_ul_ul]:!pl-5 [&_ol]:!pl-8 [&_ol_ol]:!pl-5 [&_ul]:!list-outside [&_ol]:!list-outside " + headingProse;
  ...
  return React.createElement("div", { className: outerPad },
    ...
    React.createElement("div", { className: embedInCourseDetail ? "w-full max-w-none mx-auto" : "w-full max-w-full mx-auto" },
      !embedInCourseDetail
        ? React.createElement(Button, { variant: "ghost", onClick: goBack, className: "mb-4 -ml-2 no-print" }, React.createElement(ArrowLeft, { className: "mr-2 h-4 w-4" }), " Back to All Pages")
        : null,
