...
function renderDescription(desc, fullWidth, options) {
  ...
  return (
    <div
      className={cn("text-sm leading-relaxed text-foreground/90 prose prose-sm max-w-none [&_ul]:list-disc [&_ul]:!pl-12 [&_ol]:!pl-12 [&_ul]:!list-outside [&_ol]:!list-outside [&_li]:list-item [&_a]:!underline", fullWidth ? "" : "")}
    ...
    return (
      <div className="w-full max-w-full px-3 md:px-4 lg:px-6 pb-6">
        <div className="w-full max-w-[52rem] mx-auto">
          <p className="text-sm text-muted-foreground mb-3">No linked resources for this section.</p>
